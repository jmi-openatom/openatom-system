CREATE
DATABASE IF NOT EXISTS `openatom-system`
...
(
    ...
    `participation_points` BIGINT NOT NULL DEFAULT 0 COMMENT '参加活动奖励积分',
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `updated_at` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY
(
...
(
    ...
    `checkin_points` BIGINT NOT NULL DEFAULT 0 COMMENT '扫码签到奖励积分',
