...
public enum SystemPermission {
  ...
  CHECK_IN_UPDATE("更新内部签到", "check-in:update", "api", "/check-ins/{sessionId}", "PATCH"),
  ...
  VOTE_LIST("查询投票活动", "vote:list", "api", "/votes", "GET"),
  VOTE_CREATE("创建投票活动", "vote:create", "api", "/clubs/{clubId}/votes", "POST"),
  VOTE_DETAIL("获取投票详情", "vote:detail", "api", "/votes/{voteId}", "GET"),
  VOTE_UPDATE("更新投票活动", "vote:update", "api", "/votes/{voteId}", "PATCH"),
  VOTE_MANAGE_RECORDS("管理投票记录", "vote:manage-records", "api", "/votes/{voteId}/reset", "POST"),
