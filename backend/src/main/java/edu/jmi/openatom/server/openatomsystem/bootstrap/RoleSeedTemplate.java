...
public record RoleSeedTemplate(
	...
	public static List<String> clubAdminPermissionCodes() {
		return SystemPermission.codes(
				...
				SystemPermission.REGULATION_LIST,
				SystemPermission.REGULATION_CREATE,
				SystemPermission.REGULATION_UPDATE,
				SystemPermission.REGULATION_DELETE,
				...
				SystemPermission.IMAGE_LIST,
					...
					SystemPermission.SHOWCASE_APP_MANAGE,
					SystemPermission.SHOWCASE_APP_DELETE,
				...
				SystemPermission.VOTE_CREATE,
				SystemPermission.VOTE_DETAIL,
				SystemPermission.VOTE_UPDATE,
				SystemPermission.VOTE_MANAGE_RECORDS,
				...
				SystemPermission.MEMBER_PROFILE_COMMENT_LIST,
				SystemPermission.MEMBER_PROFILE_COMMENT_MANAGE,
