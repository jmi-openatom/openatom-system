...
public class Result<T> implements Serializable {
  ...
  public static <T> Result<T> success() {
    return new Result<>(SUCCESS_CODE, SUCCESS_MESSAGE, null, DEFAULT_TRACE_ID);
  }

  public static <T> Result<T> success(T data) {
    return new Result<>(SUCCESS_CODE, SUCCESS_MESSAGE, data, DEFAULT_TRACE_ID);
  }
  ...
  public static <T> Result<T> error() {
    return new Result<>(ERROR_CODE, "操作失败", null, DEFAULT_TRACE_ID);
  }
