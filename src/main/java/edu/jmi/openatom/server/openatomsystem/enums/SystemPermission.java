...
public enum SystemPermission {
  ...
  CLUB_RECRUITMENT_STATUS_UPDATE(
      "更新社团招新状态", "club:recruitment-status:update", "api", "/clubs/{clubId}/recruitment-status", "PATCH"),
  ...
  USER_PASSWORD_RESET("重置用户密码", "user:password:reset", "api", "/users/{userId}/reset-password", "POST"),
  USER_IMPORT("导入用户与下载模板", "user:import", "api", "/users/import/**", "POST"),
  USER_MEMBERSHIP_LIST("获取用户社团关系", "user:membership:list", "api", "/users/{userId}/memberships", "GET"),
  RECRUITMENT_CAMPAIGN_LIST("查询招新计划", "recruitment-campaign:list", "api", "/clubs/{clubId}/recruitment-campaigns", "GET"),
  RECRUITMENT_CAMPAIGN_CREATE("创建招新计划", "recruitment-campaign:create", "api", "/clubs/{clubId}/recruitment-campaigns", "POST"),
  RECRUITMENT_CAMPAIGN_DETAIL("获取招新计划详情", "recruitment-campaign:detail", "api", "/recruitment-campaigns/{campaignId}", "GET"),
  RECRUITMENT_CAMPAIGN_UPDATE("更新招新计划", "recruitment-campaign:update", "api", "/recruitment-campaigns/{campaignId}", "PATCH"),
  RECRUITMENT_CAMPAIGN_PUBLISH("发布招新计划", "recruitment-campaign:publish", "api", "/recruitment-campaigns/{campaignId}/publish", "POST"),
  RECRUITMENT_CAMPAIGN_CLOSE("关闭招新计划", "recruitment-campaign:close", "api", "/recruitment-campaigns/{campaignId}/close", "POST"),
  SITE_FORM_LIST("查询信息收集表单", "site-form:list", "api", "/clubs/{clubId}/site-forms", "GET"),
  SITE_FORM_CREATE("新增信息收集表单", "site-form:create", "api", "/clubs/{clubId}/site-forms", "POST"),
  ...
  SITE_FORM_PUBLISH("发布信息收集表单", "site-form:publish", "api", "/site-forms/{formId}/publish", "POST"),
  SITE_FORM_CLOSE("关闭信息收集表单", "site-form:close", "api", "/site-forms/{formId}/close", "POST"),
  ...
  ACTIVITY_REGISTRATION_LIST("查询活动报名", "activity-registration:list", "api", "/activities/{activityId}/registrations", "GET"),
  ...
  APPLICATION_DETAIL("获取入会申请详情", "application:detail", "api", "/applications/{applicationId}", "GET"),
  APPLICATION_UPDATE("更新入会申请", "application:update", "api", "/applications/{applicationId}", "PATCH"),
  APPLICATION_SUBMIT("提交草稿申请", "application:submit", "api", "/applications/{applicationId}/submit", "POST"),
  APPLICATION_WITHDRAW("撤回入会申请", "application:withdraw", "api", "/applications/{applicationId}/withdraw", "POST"),
  APPROVAL_RECORD_LIST("查询审批记录", "approval-record:list", "api", "/applications/{applicationId}/approval-records", "GET"),
  APPLICATION_APPROVE("审批入会申请", "application:approve", "api", "/applications/{applicationId}/approvals", "POST"),
  APPLICATION_BATCH_APPROVE("批量审批入会申请", "application:batch-approve", "api", "/applications/batch-approvals", "POST"),
  ...
  INTERVIEW_CONFIRM("确认面试", "interview:confirm", "api", "/interviews/{interviewId}/confirm", "POST"),
  INTERVIEW_FEEDBACK("提交面试反馈", "interview:feedback", "api", "/interviews/{interviewId}/feedback", "POST"),
  INTERVIEW_COMPLETE("完成面试", "interview:complete", "api", "/interviews/{interviewId}/complete", "POST"),
  APPLICATION_FINAL_DECISION("终审决策", "application:final-decision", "api", "/applications/{applicationId}/final-decisions", "POST"),
  ...
  MEMBERSHIP_POSITION_ASSIGN("分配成员岗位", "membership:position:assign", "api", "/memberships/{membershipId}/assign-position", "POST"),
  MEMBERSHIP_STATUS_CHANGE("修改成员状态", "membership:status:change", "api", "/memberships/{membershipId}/change-status", "POST"),
  ...
  EXIT_APPLICATION_DETAIL("获取退社申请详情", "exit-application:detail", "api", "/exit-applications/{exitApplicationId}", "GET"),
  EXIT_APPLICATION_APPROVE("通过退社申请", "exit-application:approve", "api", "/exit-applications/{exitApplicationId}/approve", "POST"),
  EXIT_APPLICATION_REJECT("驳回退社申请", "exit-application:reject", "api", "/exit-applications/{exitApplicationId}/reject", "POST"),
  MEMBERSHIP_FORCE_EXIT("强制退社", "membership:force-exit", "api", "/memberships/{membershipId}/force-exit", "POST"),
  ...
  NOTIFICATION_READ("标记通知已读", "notification:read", "api", "/notifications/{notificationId}/read", "POST"),
