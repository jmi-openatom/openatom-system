...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'apply/:id', name: 'site-apply-detail', component: () => import('../views/site/ApplicationForm.vue') },
  ...
  { path: '/admin/login', name: 'admin-login', component: () => import('../views/admin/Login.vue') },
  {
    ...
    children: [
      ...
      { path: 'site-forms', name: 'admin-site-forms', meta: { permissions: ['site-form:list'] }, component: () => import('../views/admin/SiteForms.vue') },
      { path: 'form-submissions', name: 'admin-form-submissions', meta: { permissions: ['site-form:detail'] }, component: () => import('../views/admin/FormSubmissions.vue') },
