  ...
  <div class="admin-page">
    <div class="toolbar">
      <div class="toolbar__filters">
        <el-input v-model="query.applicationId" clearable placeholder="搜索申请ID" style="width: 220px" @keyup.enter="fetchList" />
    ...
    <el-dialog v-model="feedbackVisible" title="面试反馈" width="520px">
      <el-form :model="feedbackForm" label-width="78px">
        <el-form-item label="评分"><el-input-number v-model="feedbackForm.score" :min="0" :max="100" /></el-form-item>
        ...
        <el-form-item label="评语"><el-input v-model="feedbackForm.comment" type="textarea" :rows="4" /></el-form-item>
      </el-form>
      <template #footer>
...
export default {
  ...
  methods: {
    ...
    async fetchList() {
      this.loading = true
      try {
        const applicationId = this.query.applicationId ? Number(this.query.applicationId) : undefined
